...
import 'package:news_app_c16_6pm/features/articles/domain/use_case/get_articles_usecase.dart';
import 'package:news_app_c16_6pm/features/articles/domain/use_case/get_sources_usecase.dart';
import 'package:news_app_c16_6pm/features/articles/presntation/view_model/cubit/articles_state.dart';
  ...
  Future<void> getArticles(String sourceID, List<SourceEntity> sources) async {
    ...
    switch (response) {
      case Success<List<ArticleEntity>>():
        emit(
          GetArticlesSuccessState(sources: sources, articles: response.data),
        );

      case Failure<List<ArticleEntity>>():
        emit(
          GetArticlesError(sources: sources, error: response.error.toString()),
        );
    }
  }
}
